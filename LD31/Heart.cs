...
namespace LD31
{
    public class Heart
    {
        ...
        public void Initialize(Vector2 p_Location)
        {
            ...
            this.Sprite = new SpriteInstance(LD31.SpriteLibrary.Sprites[100], p_Location);
        ...
        {
            if (this.m_Bounds.Intersects(p_Player.CollisionBounds) && !p_Player.IsInvincible)
            {
                p_Player.Dungeon.PickUpHeart();
            }
